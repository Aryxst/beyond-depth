ServerEvents.recipes(event => {
  ...
  // Willow Table
  event
    .shaped("everycomp:vf/biomemakeover/willow_table", ["   ", "CCC", "c c"], {
  ...
  // Swamp Cypress Table
  event
    .shaped("everycomp:vf/biomemakeover/swamp_cypress_table", ["   ", "CCC", "c c"], {
  ...
  event
    .shaped("everycomp:vf/biomemakeover/blighted_balsa_table", ["   ", "CCC", "c c"], {
  ...
  // Ancient Oak Table
  event
    .shaped("everycomp:vf/biomemakeover/ancient_oak_table", ["   ", "CCC", "c c"], {
  ...
  // Willow Stool
  event
    .shaped("everycomp:vf/biomemakeover/willow_stool", ["   ", "ccc", "c c"], {
      c: "biomemakeover:willow_slab", // Slabs only
    })
  ...
  // Swamp Cypress Stool
  event
    .shaped("everycomp:vf/biomemakeover/swamp_cypress_stool", ["   ", "ccc", "c c"], {
      c: "biomemakeover:swamp_cypress_slab", // Slabs only
    })
  ...
  event
    .shaped("everycomp:vf/biomemakeover/blighted_balsa_stool", ["   ", "ccc", "c c"], {
      c: "biomemakeover:blighted_balsa_slab", // Slabs only
    })
  ...
  // Ancient Oak Stool
  event
    .shaped("everycomp:vf/biomemakeover/ancient_oak_stool", ["   ", "ccc", "c c"], {
      c: "biomemakeover:ancient_oak_slab", // Slabs only
    })
  ...
  // Willow Chair
  event
    .shaped("everycomp:vf/biomemakeover/willow_chair", ["c  ", "CCC", "c c"], {
      c: "biomemakeover:willow_slab", // Slabs only
      C: "biomemakeover:willow_planks", // Planks only
    })
  ...
  // Swamp Cypress Chair
  event
    .shaped("everycomp:vf/biomemakeover/swamp_cypress_chair", ["c  ", "CCC", "c c"], {
      c: "biomemakeover:swamp_cypress_slab", // Slabs only
      C: "biomemakeover:swamp_cypress_planks", // Planks only
    })
  ...
  event
    .shaped("everycomp:vf/biomemakeover/blighted_balsa_chair", ["c  ", "CCC", "c c"], {
      c: "biomemakeover:blighted_balsa_slab", // Slabs only
      C: "biomemakeover:blighted_balsa_planks", // Planks only
    })
  ...
  // Ancient Oak Chair
  event
    .shaped("everycomp:vf/biomemakeover/ancient_oak_chair", ["c  ", "CCC", "c c"], {
      c: "biomemakeover:ancient_oak_slab", // Slabs only
      C: "biomemakeover:ancient_oak_planks", // Planks only
    })
  ...
  // Pale Oak Table
  event
    .shaped("everycomp:vf/palegardenbackport/pale_oak_table", ["   ", "CCC", "c c"], {
  ...
  // Pale Oak Stool
  event
    .shaped("everycomp:vf/palegardenbackport/pale_oak_stool", ["   ", "ccc", "c c"], {
      c: "palegardenbackport:pale_oak_slab", // Slabs only
    })
  ...
  // Pale Oak Chair
  event
    .shaped("everycomp:vf/palegardenbackport/pale_oak_chair", ["c  ", "CCC", "c c"], {
      c: "palegardenbackport:pale_oak_slab", // Slabs only
      C: "palegardenbackport:pale_oak_planks", // Planks only
    })
  ...
  event
    .shaped("everycomp:vf/witherstormmod/tainted_table", ["   ", "CCC", "c c"], {
  ...
  event
    .shaped("everycomp:vf/witherstormmod/tainted_stool", ["   ", "ccc", "c c"], {
      c: "witherstormmod:tainted_slab", // Slabs only
    })
    .id("everycomp:vf/witherstormmod/tainted_stool");

  event
    .shaped("everycomp:vf/witherstormmod/tainted_chair", ["c  ", "CCC", "c c"], {
      c: "witherstormmod:tainted_slab", // Slabs only
      C: "witherstormmod:tainted_planks", // Planks only
    })
