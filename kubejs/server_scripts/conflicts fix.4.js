ServerEvents.recipes(event => {
  ...
  // Claret Table
  event
    .shaped("everycomp:vf/netherexp/claret_table", ["   ", "CCC", "c c"], {
  ...
  event
    .shaped("everycomp:vf/ecologics/flowering_azalea_table", ["   ", "CCC", "c c"], {
  ...
  // Azalea Table
  event
    .shaped("everycomp:vf/ecologics/azalea_table", ["   ", "CCC", "c c"], {
  ...
  // Coconut Table
  event
    .shaped("everycomp:vf/ecologics/coconut_table", ["   ", "CCC", "c c"], {
  ...
  event
    .shaped("everycomp:vf/ecologics/walnut_table", ["   ", "CCC", "c c"], {
  ...
  event
    .shaped("everycomp:vf/valhelsia_structures/lapidified_jungle_table", ["   ", "CCC", "c c"], {
  ...
  // Scorched Table
  event
    .shaped("everycomp:vf/born_in_chaos_v1/scorched_table", ["   ", "CCC", "c c"], {
  ...
  // Chorus Table
  event
    .shaped("everycomp:vf/cataclysm/chorus_table", ["   ", "CCC", "c c"], {
  ...
  // Thunder Table
  event
    .shaped("everycomp:vf/voidscape/thunder_table", ["   ", "CCC", "c c"], {
  ...
  // Thornwood Table
  event
    .shaped("everycomp:vf/alexscaves/thornwood_table", ["   ", "CCC", "c c"], {
  ...
  // Stone Pine Table
  event
    .shaped("everycomp:vf/snifferplus/stone_pine_table", ["   ", "CCC", "c c"], {
  ...
  // Echo Table
  event
    .shaped("everycomp:vf/deeperdarker/echo_table", ["   ", "CCC", "c c"], {
  ...
  // Driftwood Table
  event
    .shaped("everycomp:vf/upgrade_aquatic/driftwood_table", ["   ", "CCC", "c c"], {
  ...
  // River Table
  event
    .shaped("everycomp:vf/upgrade_aquatic/river_table", ["   ", "CCC", "c c"], {
  ...
  // rotten table
  event
    .shaped("everycomp:vf/betterarcheology/rotten_table", ["   ", "CCC", "c c"], {
  ...
  // Pewen Table
  event
    .shaped("everycomp:vf/alexscaves/pewen_table", ["   ", "CCC", "c c"], {
